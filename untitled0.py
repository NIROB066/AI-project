...
def display_grid():
    global flag,grid_flag,player_computer,player_human,filled_ara,n,grid_number_nirob
    grid_number_nirob = 0
    p,q,k=-5,-5,-5
    if(flag==0):
...
def human_play_turn2():
    global player_computer,filled_ara,chal_successful,count_number_move,n
    if count_number_move==1:
        print("Riya has given his move")
    display_grid()
    #condition which code he can chose(kon kon ghure chal dite parbe)..................
    print()
    print()
    print("Nirob have the following choice")
    valid_grid=[]
    for i in range(n*n):
    ...
    root=input("Nirob, Which grid do you want?")
    note=int(root);
    chal_successful=0
...
def human_play_turn():
    ...
    if count_number_move==1:
        print("Nirob has given his move")
    display_grid()
    #condition which code he can chose(kon kon ghure chal dite parbe)..................
    print()
    print()
    print("Riya have the following choice")
    valid_grid=[]
    for i in range(n*n):
        if edges[player_human][i]==1 and filled_ara[i]==0:
            ...
            valid_grid.append(i)
    #condition for choosing a ghur is over.............................................
    root=input("Riya, Which grid do you want?")
    note=int(root);
    chal_successful=0
...
def selecting_first_player():
    ...
    if player_initial_flag==0:
        print()
        print()
        print("Blue is Nirob and green is Riya")
        player=input("Enter the Choice:\n a for giving Nirob first move \n b for giving Riya first move : ")
        if player=="a":
            player_turn=0
        elif player=="b":
            player_turn=1
